...
-- Atualizando as receitas com o modo de preparo completo
UPDATE receita SET modo_preparo = '1. Corte a carne seca em pedaços e deixe de molho em água por cerca de 12 horas, trocando a água algumas vezes para dessalgar.\n2. Cozinhe a carne seca em uma panela de pressão por 30 minutos ou até ficar macia.\n3. Após o cozimento, desfie a carne e reserve.\n4. Em uma panela grande, aqueça o óleo e refogue a cebola e o alho até dourarem.\n5. Adicione a carne seca desfiada, o tomate picado e os temperos a gosto.\n6. Cozinhe por alguns minutos, mexendo bem, até que todos os ingredientes estejam incorporados.\n7. Sirva com arroz branco e uma salada verde.' WHERE nome_rec = 'Arras Carne Seca';

UPDATE receita SET modo_preparo = '1. Tempere as carnes com sal grosso e deixe descansar por 15 minutos.\n2. Acenda o fogo e deixe a grelha esquentar bem antes de colocar as carnes.\n3. Coloque as carnes na grelha e asse de acordo com o ponto desejado, virando de tempos em tempos.\n4. Sirva o churrasco com farofa, vinagrete e pão de alho.' WHERE nome_rec = 'Churrasco Maracanã';

UPDATE receita SET modo_preparo = '1. Deixe as carnes salgadas de molho na água de um dia para o outro, trocando a água algumas vezes para retirar o excesso de sal.\n2. Cozinhe as carnes separadamente e reserve.\n3. Em uma panela grande, refogue o alho e a cebola no óleo até dourar.\n4. Acrescente o feijão e cubra com água.\n5. Adicione as carnes ao feijão e deixe cozinhar até o caldo engrossar e o feijão ficar macio.\n6. Finalize com o tempero verde a gosto e sirva com arroz branco e couve refogada.' WHERE nome_rec = 'Feijoada';

UPDATE receita SET modo_preparo = '1. Corte a carne em tiras finas e tempere com sal e pimenta a gosto.\n2. Em uma panela, aqueça o óleo e doure a carne aos poucos.\n3. Adicione a cebola e o alho, refogando até ficarem transparentes.\n4. Acrescente o ketchup, a mostarda e o molho inglês.\n5. Adicione o creme de leite e misture bem.\n6. Deixe cozinhar em fogo baixo até o molho engrossar e a carne ficar macia.\n7. Sirva o strogonoff com arroz branco e batata palha.' WHERE nome_rec = 'Strogonoff';
