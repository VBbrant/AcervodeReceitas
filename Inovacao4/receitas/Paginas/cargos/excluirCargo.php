...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $sql_nome_categoria = "SELECT nome FROM cargo WHERE idCargo = ?";
        ...
        // Exclui categoria
        $sql_delete_categoria = "DELETE FROM cargo WHERE idCargo = ?";
        ...
        registrarLog($conn, $idUsuario, "exclusao", "Exclusão do cargo '$nome_categoria' realizado com sucesso!");
        header("Location: " . BASE_URL . "receitas/Paginas/cargos/listaCargo.php?excluido=1");
        exit;
    } catch (Exception $e) {
        $conn->rollback();
        echo "Erro ao excluir a cargo: " . $e->getMessage();
    }
}
...
<div class="container mt-5">
    ...
    <p>Tem certeza de que deseja excluir esta cargo?</p>
    <form method="POST">
        <button type="submit" class="btn btn-danger">Excluir</button>
        <a href="<?php echo BASE_URL; ?>receitas/Paginas/cargos/listaCargo.php" class="btn btn-secondary">Cancelar</a>
    </form>
</div>
</body>
</html>
